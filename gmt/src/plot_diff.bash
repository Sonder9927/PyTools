...
ant=$2
#stddev=$3
grdfile=boundary_20220422.txt #grid2dv.30.z.txt
cptfile=test.cpt
TOPO_GRD=topo.grd
TOPO_GRD2=topo.grd2
...
gmt grdimage diff1.grd -Cvs_dif.cpt -I$TOPO_GRA
gmt clip -C
#cat $stddev | gmt blockmean -R$range -I0.25/0.25 > stdtmp
#gmt surface stdtmp -Gstd.grd -R$range -I0.5
#gmt grdsample std.grd -I0.02 -Gstd.grd2
#gmt grdcontour std.grd2 -C18,20,25,30 -A18,20,25,30 -Wblack,-
cat station.1021163044.lst | awk '{print $2,$3}' | gmt psxy -St0.1c -Gblue -Wblack
cat ncc_lv.xy | gmt psxy -W0.8p,black
gmt colorbar -Cvs_dif.cpt -DjBC+w8c/0.4c+o0c/-1.5c+m -Bxa30f30
echo "test3"
