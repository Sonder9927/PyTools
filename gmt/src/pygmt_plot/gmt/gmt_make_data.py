...
def diff_make(ant, tpwt, region, cptfile, ant_grd, tpwt_grd, outgrid):
    ...
    ant_sf = tomo_grid_data(ant, ant_grd, region, "ant")
    # make vel grid of tpwt and get vel grid generated by `surface`
    tpwt_sf = tomo_grid_data(tpwt, tpwt_grd, region, "tpwt")
...
def tomo_grid_data(data, outgrid, region, preffix="") -> str:
    bm_out = "temp/bm_temp"
    sf_grd = "temp/sf.grd"
    gmt_blockmean_surface_grdsample(
